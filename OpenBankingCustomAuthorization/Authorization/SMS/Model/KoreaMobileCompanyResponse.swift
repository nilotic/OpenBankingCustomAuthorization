// 
//  KoreaMobileCompanyResponse.swift
//
...
struct KoreaMobileCompanyResponse {
...
extension KoreaMobileCompanyResponse {
    ...
    init(value: Any?, cookie: HTTPCookie) throws {
        guard let htmlString = value as? String,
              let regularExpression = try? NSRegularExpression(pattern: "<form name=\"smsReqForm\" method=\"post\" action=\"\">(?:\".*?\"|\'.*?\'|[^\'\"])*?</form>", options: [.dotMatchesLineSeparators]),
